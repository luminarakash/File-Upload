...
exports.imageUpload = async (req, res) => {
    try{
        ...
        console.log("Uploading to Luminarakash");
        const response = await uploadFileToCloudinary(file, "Luminarakash");
...
exports.imageSizeReducer = async (req,res) => {
    try{
        ...
        const response = await uploadFileToCloudinary(file, "Luminarakash", 90);
        console.log(response);
